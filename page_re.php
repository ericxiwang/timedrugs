...
?>
    <!--nav end -->
     ...
     <?php
     $query_all_pro  = "SELECT pro_name,pro_img,pro_o_price,pro_code,promotion_enabled,promotion_id from product_info where pro_recommend != '0' and pro_onsell='1' order by pro_recommend ";
